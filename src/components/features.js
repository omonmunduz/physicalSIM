            ...
            <dl className="space-y-10 md:space-y-0 md:grid md:grid-cols-2 md:gap-x-8 md:gap-y-10">
              ...
              <div className="relative">
                <dt>
                  ...
                  <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Global packages</p>
                </dt>
                <dd className="mt-2 ml-16 text-base text-gray-500">
                No matter where is your next destination, you can choose from a variaty of pacakges that suits your needs from our website.
                </dd>
              </div>
              ...
              <div className="relative">
                <dt>
                  ...
                  <p className="ml-16 text-lg leading-6 font-medium text-gray-900">Easy refills</p>
                </dt>
                <dd className="mt-2 ml-16 text-base text-gray-500">
                Create or login to your account, enter or choose your iccid, select a package and checkout.
                </dd>
              </div>
