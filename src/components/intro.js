    ...
    return (
        ...
        <div className ="w-11/12 flex justify-center flex-col mt-16 ">
            <div className="w-full">
                <h2 className="text-4xl text-center text-indigo-600 md:text-5xl lg: text-6xl">Hello Smart SIM</h2>
            ...
            <div className="bg-gray-50 w-full">
                <div className="max-w-7xl mx-auto py-12 px-4 sm:px-6 lg:py-16 lg:px-8 lg:flex lg:items-center lg:justify-between">
                    ...
                    <span className="block"><span className="text-yellow-500 ">1) </span>Order a SKYgo Global SIM from our website or from our dealers</span>
                    <span className="block text-gray-700 text-base mt-3">Create an account on www.skygosim.com</span>
                    <span className="block text-gray-700 text-base mt-3">Enter your iccid wwww.skygosim.com/add-sim </span>
                    </h2>
